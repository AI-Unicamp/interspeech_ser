...
for epoch in range(EPOCHS):
    ...
    for batch in tqdm(train_loader):
        ...
        # else:
        loss_wce = utils.CE_weight_category(logits, ce_y, class_weights_tensor)

        loss = f1loss(logits, y)

        total_loss = (loss + loss_wce) / ACCUMULATION_STEP
