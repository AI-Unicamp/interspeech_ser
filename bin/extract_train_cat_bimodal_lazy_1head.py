'''
    Just extracting train probas to evaluate and to train a stacking model
'''
import pandas as pd
import torch
...
parser.add_argument("--train_df", type=str, default="./test/train_stacking_sample.csv")
...
def save_predictions_with_probs(total_pred, total_utt, map_argmax, model_path, dtype='train'):
    data = []
...
csv = save_predictions_with_probs(total_pred, total_utt, map_argmax, MODEL_PATH, dtype='train')