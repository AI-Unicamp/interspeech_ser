...
class MultiLabelAudioDataset(Dataset):
    def __init__(self, wav_files, lazy_path1, lazy_path2, lazy_path3):
...
val_dataset = MultiLabelAudioDataset(test_df['FileName'].tolist(), lazy_path1, lazy_path2, lazy_path3)
