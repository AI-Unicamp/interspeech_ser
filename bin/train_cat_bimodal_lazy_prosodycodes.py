...
def collate_fn(batch):
    ...
    padded_feats3 = pad_sequence(feats3, batch_first=True, padding_value=1024)  # (batch_size, max_seq_len, feat_dim)
...
class MultiModalEmotionClassifier(nn.Module):
    def __init__(
        ...
        self.prosody_projection = nn.Embedding(features3_dim, fusion_hidden_dim)
...
for epoch in range(EPOCHS):
    ...
    for batch in tqdm(train_loader):
        ...
        inputs3 = batch["feat3"].cuda(non_blocking=True).long()
